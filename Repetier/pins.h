...
// Start Innovo Inventor Board 2.0
#if MOTHERBOARD == 467
#ifndef __SAM3X8E__
...
#define ORIG_X_MIN_PIN      28 // originally 28, changed to 38 as Zmax pin
...
#define ORIG_Z_MAX_PIN      38 // (originally 38, set to 32 for stallguard as Zprobe)
